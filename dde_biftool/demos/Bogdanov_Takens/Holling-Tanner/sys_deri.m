...
elseif length(nx) == 2 && isempty(np) && ~isempty(v)
	...
	case 0
		switch nx2
		case 0
			J = [(-2+2*xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^2-2*xx(1,1)*xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^3)*v(1)+(-1/(par(3)*xx(2,1)+xx(1,1))+xx(1,1)/(par(3)*xx(2,1)+xx(1,1))^2+xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^2*par(3)-2*xx(1,1)*xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^3*par(3))*v(2), (-1/(par(3)*xx(2,1)+xx(1,1))+xx(1,1)/(par(3)*xx(2,1)+xx(1,1))^2+xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^2*par(3)-2*xx(1,1)*xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^3*par(3))*v(1)+(2*xx(1,1)/(par(3)*xx(2,1)+xx(1,1))^2*par(3)-2*xx(1,1)*xx(2,1)/(par(3)*xx(2,1)+xx(1,1))^3*par(3)^2)*v(2); 0, 0];
		case 1
