...
\subsection{Changes from 3.0 to \version}
\label{sec:v3to31}
...
version 3.0 onward are now available from \ddebifweb{}. Older versions
will contrinue to be available from \ddebifwebold{}.
...
Version from 3.0 onward have a different the user interface for many
...
\item continuation of normal form coefficients for Hopf bifurcations
...
Useful options to be set in \texttt{octave}:
\begin{compactitem}
